...
<div class="container-fluid bg-white p-4 rounded shadow-sm mb-4">
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-6 ps-md-4">
            ...
            <p class="mb-2"><strong>Serial Num:</strong> <span class="badge bg-light text-dark border">${ci.serialNumber
    ...
    <div class="mb-4">
        ...
        <div class="p-3 bg-light rounded mt-2 border">${ci.description == null ? '<span class="text-muted fst-italic">No
...
<div class="container-fluid p-4 rounded shadow-sm border border-warning mb-4" style="background-color: #fffdf5;">
    <h3 class="h5 text-warning mb-3"><i class="bi bi-exclamation-triangle-fill"></i> Impact Analysis (What happens if
        this CI fails?)</h3>
                ...
                <tbody>
                    <c:forEach var="rel" items="${relationships}">
                        <tr>
                            ...
                            <td class="text-info fw-bold"><i class="bi bi-arrow-right"></i> ${rel.relationshipType}</td>
                            <td>
