        ...
        <div class="wrapper">
            <div class="sidebar">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="menu-header">Workflow & Service</li>
                        ...
                        <span class="fw-bold">
                            <c:choose>
                                <c:when test="${pageContext.request.requestURI.contains('/admin/users')}">Quản lý người
                                    dùng</c:when>
                                <c:when test="${pageContext.request.requestURI.contains('/workflows')}">Quản lý Workflow
                                </c:when>
                                <c:when test="${pageContext.request.requestURI.contains('/ticket-category')}">Ticket
                                    Categories</c:when>
                                <c:when test="${pageContext.request.requestURI.contains('/time-tracking')}">Quản lý Time
                                    Log</c:when>
