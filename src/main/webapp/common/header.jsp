                        ...
                        <c:choose>
                            <c:when test="${not empty sessionScope.user}">
                                <c:if test="${sessionScope.user.roleName == 'Admin'}">
                                    <li class="nav-item">
                                        <a class="nav-link me-3" href="${pageContext.request.contextPath}/admin/users">Quản lý User</a>
                                    </li>
                                </c:if>
                                <li class="nav-item dropdown">
                                    <a class="nav-link d-flex align-items-center" href="#" id="userDropdown" role="button" data-bs-toggle="dropdown">
                                        ...
                                        <li><a class="nav-link d-flex align-items-center dropdown-item text-danger" href="${pageContext.request.contextPath}/auth?action=logout">Đăng xuất</a></li>
                                </li>
                            </c:when>
                            <c:otherwise>
                                <li class="nav-item">
                                    <a class="btn btn-primary px-4 rounded-pill" href="${pageContext.request.contextPath}/login">Đăng nhập</a>
                                </li>
                            </c:otherwise>
                        </c:choose>
                    </ul>
