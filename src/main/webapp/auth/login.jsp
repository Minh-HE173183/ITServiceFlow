...
<html lang="vi">
    <head>
        ...
        <style>
            ...
            .btn-submit:hover {
                background: #2c3e50; /* Darker charcoal blue to differentiate from Facebook button */
                transform: translateY(-2px);
...
<div class="login-wrapper">
    <div class="login-left">
        ...
        <h1>Hey you!</h1>
        <p>You feel lost? Join us to streamline your IT service workflow with our professional management system.</p>
    ...
    <div class="login-right">
        ...
        <form action="${pageContext.request.contextPath}/auth?action=login" method="post">
            ...
            <div class="mt-3 text-end">
                <a href="${pageContext.request.contextPath}/auth?action=forgotPassword" class="text-primary text-decoration-none small fw-bold">Quên mật khẩu?</a>
            </div>
