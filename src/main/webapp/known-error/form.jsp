...
<div class="container-fluid bg-white p-4 rounded shadow-sm" style="max-width: 800px; margin: auto;">
    <h2 class="h4 text-primary mb-4 border-bottom pb-2">${not empty knownError ? 'Update Known Error' : 'Create Known
        Error'}</h2>
    ...
    <form <form
        ...
        <div class="mb-3">
            <label for="symptom" class="form-label fw-bold">Symptoms & Errors <span class="text-danger">*</span></label>
